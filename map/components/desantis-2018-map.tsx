  ...
  React.useEffect(() => {
    ...
    map.on("load", function () {
      ...
      map.addSource("precincts", {
        type: "geojson",
        data:
          "https://raw.githubusercontent.com/Open-Data-Tallahassee/geojson-dump/main/2018-general-desantis-results.geojson",
        generateId: true,
      });
    ...
    map.on('click', function(mapElement) {
      ...
      const html = `Precinct ${number} - ${name}: ${100*percent}% voted for Ron DeSantis`
