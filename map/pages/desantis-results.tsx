...
import Map from '../components/desantis-2018-map'
import Map2 from '../components/desantis-2022-map'
...
const Home: NextPage = () => {
  return (
    ...
    <div className={styles.container}>
      <Head>
        <meta name="description" content="Map of Ron DeSantis' 2018 Election Results" />
      ...
      <div className="text-lg text-center mt-5 text-grey-900 sm:text-3xl ">2018 vs 2022 General Election Voter Turnout for Ron DeSantis:</div>
