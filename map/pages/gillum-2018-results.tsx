...
import Map from '../components/gillum-2018-map'
...
const Home: NextPage = () => {
  return (
    ...
    <div className={styles.container}>
      <Head>
        <meta name="description" content="Map of Andrew Gillum's 2018 Election Results" />
      ...
      <div className="text-lg text-center mt-5 text-grey-900 sm:text-4xl ">2018 General Election Voter Turnout for Andrew Gillum:</div>
